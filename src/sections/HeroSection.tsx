...
// Desktop Hero Component - Improved with flexible positioning
const DesktopHeroSection: React.FC = () => {
  return (
    <div className='relative'>
      {/* Hero Section - Flexible height with space for dashboard */}
      <section className='relative h-screen min-h-[600px] max-h-[900px] flex flex-col items-center justify-start pt-16 overflow-hidden'>
        {/* Hero Building Background */}
        <div className='absolute inset-0'>
          <Image
            src='/hero.jpg'
        ...
        <div className='container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-32 pb-32'>
          <div className='flex flex-col items-center text-center space-y-6 max-w-4xl mx-auto'>
            {/* Main Heading */}
            <h1 className='max-w-3xl text-3xl md:text-4xl xlg:text-5xl font-extrabold text-white leading-tight'>
            ...
            <div className='relative w-full max-w-lg'>
              <div className='relative'>
                ...
                <input
                  type='text'
                  placeholder='Search Properties by Location'
                  className='w-full px-6 py-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full text-white placeholder-gray-300 focus:outline-none focus:ring-1 focus:ring-secondary focus:border-transparent transition-all duration-200'
                />
                <div className='absolute inset-y-0 right-0 pr-2 flex items-center'>
                  <button className='bg-secondary hover:bg-secondary/90 text-white p-2.5 rounded-full transition-all duration-300 hover:scale-105'>
            ...
            <div className='flex flex-wrap justify-center gap-3 pt-2'>
              <div className='flex items-center bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 border border-white/20 hover:bg-white/15 transition-all duration-200'>
                <Image src={OwnerVerifiedIcon} alt='Owner Verified' width={16} height={16} className='mr-2' />
                <span className='text-white text-sm font-medium'>Owner Verified</span>
              </div>
              <div className='flex items-center bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 border border-white/20 hover:bg-white/15 transition-all duration-200'>
      ...
      {/* Dashboard Mockup - Positioned within allocated space */}
      <div className='relative z-20 w-full flex justify-center px-4 sm:px-6 lg:px-8 -mt-[20vh] pb-16'>
        <div className='w-full max-w-5xl flex justify-center'>
          <Image
            ...
            priority
            quality={95}
            // className='w-full max-w-4xl h-auto object-contain drop-shadow-2xl mx-auto rounded-lg'
            // sizes='(max-width: 768px) 90vw, (max-width: 1200px) 80vw, 70vw'

            className='w-full md:max-w-3xl 2xl:max-w-5xl h-auto object-contain drop-shadow-2xl mx-auto'
